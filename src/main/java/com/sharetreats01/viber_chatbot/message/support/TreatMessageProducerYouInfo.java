...
public class TreatMessageProducerYouInfo implements TreatMessageProducer {
    ...
    public MessageRequest produceMessage(MessageProcessContext context) {
        log.info("Message Produce Treat Your Info");
        return TextMessageRequest.createDefault(context.getReceiverId(), context.getSenderName(), context.getSenderAvatar(), context.getMinApiVersion(), treatMessageUtils.pasteInputData(context.getTrackingData(), context.getInput()), "Enter Your Info");
    }
}
